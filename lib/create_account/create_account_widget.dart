...
class CreateAccountWidget extends StatefulWidget {
  ...
  }) : isStudentAccount = isStudentAccount ?? true;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'pn3n6qeo' /* Let's get started by filling o... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                ...
                                Form(
                                  ...
                                  child: Visibility(
                                    visible: !widget.isStudentAccount,
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        Padding(
                                          ...
                                          children: [
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                '2yq7upcd' /* Already have an account?  */,
                                              ),
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'z6p0jzbj' /* Are you an organization?  */,
                                                ),
                                                style: const TextStyle(),
                                              ),
                                              TextSpan(
