...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.birthYearController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.birthdayYear, 0).toString());
                            ...
                            child: Padding(
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) => TextFormField(
                                  ...
                                  minLines: null,
                                  validator: _model.latsNameControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            ...
                            child: Padding(
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) => TextFormField(
                                  ...
                                  minLines: null,
                                  validator: _model.birthYearControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
